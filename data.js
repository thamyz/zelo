...
// ================================================================
// PROFILES
// Used by the swipe card deck on the Practice tab.
// Each profile has a baked-in difficulty so chat timing is set
// automatically when the user swipes right — no separate picker needed.
// `color` equals gradientColors[0] so startChat() can read it unchanged.
// ================================================================
...
const PROFILES = [
  ...
  // ── Pool: 21–29 ──────────────────────────────────────────────
  {
    ...
    bio: "Usually studying or hunting for a good cafe. Somehow always running late.",
    interests: ["Coffee", "Dogs", "Travel", "Yoga"],
    initial: "E",
  ...
  },
  {
    ...
    age: 24,
    occupation: "UX Designer",
    bio: "Addicted to good design and bad reality TV. Will talk your ear off about fonts.",
    interests: ["Rock climbing", "Specialty coffee", "Thrifting", "Reality TV"],
    initial: "L",
  ...
  },
  {
    ...
    age: 26,
    occupation: "Registered Nurse",
    bio: "ER nurse by day, amateur chef by night. My schedule is chaos and I love it.",
    interests: ["Cooking", "Running", "K-dramas", "Yoga"],
    initial: "N",
  ...
  },
  {
    ...
    age: 28,
    occupation: "Marketing Director",
    bio: "I convinced brands to pay me to be online. In person I'm surprisingly introverted.",
    interests: ["Cycling", "Wine", "Travel", "Podcasts"],
    initial: "G",
  ...
  },
  {
    ...
    age: 27,
    occupation: "Startup Founder",
    bio: "Building something from scratch is the hardest thing I've ever done. Worth it.",
    interests: ["Entrepreneurship", "Yoga", "Matcha", "Rock climbing"],
    initial: "M",
  ...
  },
  {
    ...
    age: 23,
    occupation: "Psychology PhD Student",
    bio: "I will absolutely analyze your attachment style. You've been warned.",
    interests: ["Live music", "Board games", "Running", "Documentaries"],
    initial: "C",
  ...
  },
  {
    ...
    age: 29,
    occupation: "Architect",
    bio: "Designs spaces for other people then goes home to a chaotic apartment and a half-read novel.",
    interests: ["Travel", "Cooking", "Reading", "Interior design"],
    initial: "R",
  ...
  },
  {
    ...
    age: 25,
    occupation: "Physical Therapist",
    bio: "Helps people move better for a living. Either on a trail, in a gym, or aggressively napping.",
    interests: ["Hiking", "Fitness", "Nutrition", "Cold plunges"],
    initial: "A",
  ...
  },
  {
    ...
    age: 26,
    occupation: "Journalist",
    bio: "Writes about things that matter. Ask about the last great article she read — she'll talk for an hour.",
    interests: ["Writing", "Boxing", "Coffee", "Politics"],
    initial: "P",
  ...
  },
  {
    ...
    age: 27,
    occupation: "Art Director",
    bio: "Former art student, current overthinker. Good design, slow mornings, never a bad playlist.",
    interests: ["Art", "Indie music", "Vintage clothing", "Photography"],
    initial: "S",
  ...
  // ── Pool: 16–20 ──────────────────────────────────────────────
  {
    ...
    bio: "Sketchbook always in my bag. Painting, thrifting, and trying every coffee shop in the city.",
    interests: ["Art", "Thrifting", "Photography", "Coffee"],
    initial: "J",
  ...
  },
  {
    ...
    bio: "Studying way too hard and stress-baking on weekends. Ask me about my sourdough starter.",
    interests: ["Baking", "Running", "K-dramas", "Hiking"],
    initial: "M",
  ...
  },
  {
    ...
    bio: "Guitar, late nights, and way too many Spotify playlists. Currently trying to write a song that doesn't suck.",
    interests: ["Live music", "Indie music", "Songwriting", "Yoga"],
    initial: "Z",
  ...
  },
  {
    ...
    bio: "College apps, drama club, and too many opinions about films. Trying to figure everything out.",
    interests: ["Film photography", "Books", "Running", "Art"],
    initial: "I",
  ...
  // ── Pool: 30+ ────────────────────────────────────────────────
  {
    ...
    age: 32,
    occupation: "Doctor",
    bio: "ER doctor who somehow still cooks dinner most nights. My hobbies are sleep and weekend hikes.",
    interests: ["Hiking", "Cooking", "Reading", "Yoga"],
    initial: "C",
    gradientColors: ["#43e97b", "#38f9d7"],
    color: "#43e97b",
    difficulty: "easy",
  ...
  },
  {
    ...
    age: 35,
    occupation: "Lawyer",
    bio: "Corporate law by day, obsessive home chef by night. I have opinions about pasta and I will share them.",
    interests: ["Cooking", "Wine", "Travel", "Podcasts"],
    initial: "S",
    gradientColors: ["#f7971e", "#ffd200"],
    color: "#f7971e",
    difficulty: "medium",
  ...
  },
  {
    ...
    bio: "Spent my twenties optimizing everything — including myself. Now I'm learning to slow down. Mostly failing.",
    interests: ["Cycling", "Specialty coffee", "Travel", "Rock climbing"],
    initial: "K",
    gradientColors: ["#4facfe", "#00f2fe"],
    color: "#4facfe",
    difficulty: "hard",
  ...
  },
  {
    ...
    bio: "I've renovated three apartments and one marriage. Only the apartment turned out exactly right.",
    interests: ["Interior design", "Art", "Wine", "Running"],
    initial: "A",
    gradientColors: ["#f093fb", "#f5576c"],
    color: "#f093fb",
    difficulty: "expert",
